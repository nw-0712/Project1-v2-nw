...
* As a customer, I want to find the main social media links to the institute.
...
### Manual testing
* Browser Compatibility and no functionality issues.
* The website has been tested on the Goolgle Chrome and Microsfot Edge browsers.
* Made sure navigation CTA buttons and form is working.
* Made sure all links to social media sites are all working properly.

### Finshed website
![image](https://github.com/user-attachments/assets/1d80aa76-9bda-420c-8a40-6a07982fd071)

![image](https://github.com/user-attachments/assets/8ec6b27a-07db-4d5c-a291-05d380ead337)
